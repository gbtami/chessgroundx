...
function wrap(element, s, relative) {
    ...
    if (s.coordinates) {
        ...
        if (shogi) {
            container.appendChild(renderCoords(types_1.files.slice(0, s.dimensions.height).reverse(), 'files' + orientClass));
