export type Variant = 'chess' | 'makruk' | 'cambodian' | 'sittuyin' | 'shogi' | 'minishogi' | 'kyotoshogi' | 'xiangqi' | 'minixiangqi' | 'capablanca' | 'seirawan' | 'capahouse' | 'shouse' | 'grand' | 'grandhouse' | 'gothic' | 'gothhouse' | 'shako' | 'shogun' | 'janggi' | 'makpong' | 'orda' | 'synochess' | 'manchu' | undefined;
export type Color = 'white' | 'black';
export type Role = 'king' | 'queen' | 'rook' | 'bishop' | 'knight' | 'pawn' | 'cancellor' | 'archbishop' | 'ferz' | 'met' | 'gold' | 'silver' | 'lance'| 'ppawn' | 'pknight' | 'pbishop' | 'prook' | 'psilver' | 'plance' | 'advisor' | 'cannon' | 'hawk' | 'elephant' | 'pferz' | 'yurt' | 'lancer' | 'banner';
...
export const enum Geometry {dim8x8, dim9x9, dim10x8, dim9x10, dim10x10, dim5x5, dim7x7};
export const enum Notation {DEFAULT, SAN, LAN, SHOGI_HOSKING, SHOGI_HODGES, JANGGI, XIANGQI_WXF};

export const dimensions: BoardDimensions[] = [{width: 8, height: 8}, {width: 9, height: 9}, {width: 10, height: 8}, {width: 9, height: 10}, {width: 10, height: 10}, {width: 5, height: 5}, {width: 7, height: 7}];
