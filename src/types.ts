export type Variant = 'chess' | 'makruk' | 'cambodian' | 'sittuyin' | 'shogi' | 'minishogi' | 'xiangqi' | 'minixiangqi' | 'capablanca' | 'seirawan' | 'capahouse' | 'shouse' | 'grand' | 'grandhouse' | 'gothic' | 'gothhouse' | 'shako' | undefined;
