export type Variant = 'chess' | 'makruk' | 'cambodian' | 'sittuyin' | 'shogi' | 'minishogi' | 'xiangqi' | 'minixiangqi' | 'capablanca' | 'seirawan' | 'capahouse' | 'shouse' | 'grand' | 'grandhouse' | 'gothic' | 'gothhouse' | 'shako' | 'shogun' | 'janggi' | undefined;
export type Color = 'white' | 'black';
export type Role = 'king' | 'queen' | 'rook' | 'bishop' | 'knight' | 'pawn' | 'cancellor' | 'archbishop' | 'ferz' | 'met' | 'gold' | 'silver' | 'lance'| 'ppawn' | 'pknight' | 'pbishop' | 'prook' | 'psilver' | 'plance' | 'advisor' | 'cannon' | 'hawk' | 'elephant' | 'pferz';
